  ...
  changeSlide = nbSlide => {
    ...
    TweenLite.fromTo(
      ...
      },
      {
        scaleX: 1,
        onComplete: () => {
          if (nbSlide === slides.length - 1) nbSlide = -1
            ...
            <div className="Slider__right__container">
              <div onClick={this.changeSlide.bind(this, 0)}>
                <div className="Slide__content">
                  ...
                  <FormattedMessage id={content[0].title} tagName="h3" />
                  <FormattedMessage id={content[0].paragraph} tagName="p" />
                </div>
              </div>
              <div onClick={this.changeSlide.bind(this, 1)}>
                <div className="Slide__content Slide__content--opacity">
                  ...
                  <FormattedMessage id={content[1].title} tagName="h3" />
                  <FormattedMessage id={content[1].paragraph} tagName="p" />
                </div>
              </div>
              <div onClick={this.changeSlide.bind(this, 2)}>
                <div className="Slide__content Slide__content--opacity">
                  ...
                  >
                    <path
                      d="M17.5 0L32.6554 26.25L2.34456 26.25L17.5 0Z"
                  ...
                  <FormattedMessage id={content[2].title} tagName="h3" />
                  <FormattedMessage id={content[2].paragraph} tagName="p" />
                </div>
              </div>
            </div>
          </div>
